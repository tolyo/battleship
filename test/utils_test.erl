...
get_random_binary_returns_one_of_two_test() ->
    Val1 = <<"value1">>,
    Val2 = <<"value2">>,
    Result = utils:get_random_binary(Val1, Val2),
...
get_random_binary_returns_both_values_test() ->
    Val1 = atom1,
    Val2 = atom2,
    Results = [utils:get_random_binary(Val1, Val2) || _ <- lists:seq(1, 100)],
...
get_random_binary_with_different_types_test() ->
    Result1 = utils:get_random_binary(1, 2),
    ?assert(Result1 =:= 1 orelse Result1 =:= 2),
    Result2 = utils:get_random_binary(<<"binary1">>, <<"binary2">>),
    ?assert(Result2 =:= <<"binary1">> orelse Result2 =:= <<"binary2">>),
    Result3 = utils:get_random_binary([1, 2, 3], [4, 5, 6]),
